...
export default class Archivist extends events.EventEmitter {
  ...
  async generateDocumentVersion(documentDeclaration, { isRefiltering = false } = {}) {
    ...
    const snapshots = await this.getDocumentSnapshots(documentDeclaration); // TODO do not store snapshtos in the previous loop in order to…
    ...
    return this.recordVersion({
      ...
      serviceId,
      documentType,
      fetchDate: snapshots[0].fetchDate, // TODO
      isRefiltering,
    });
  }
